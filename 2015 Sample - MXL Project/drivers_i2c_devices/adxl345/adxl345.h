...
/******************************************************************************
* Register Map: There is a cool visualization:
* here http://www.i2cdevlib.com/devices/adxl345#registers 
* Also see the device sheet for more info
******************************************************************************/
...
// DEVID register
uint8_t getDeviceID_ADXL345(void);
...
int8_t getOffsetX(void);
void setOffsetX(int8_t x);
int8_t getOffsetY(void);
void setOffsetY(int8_t y);
int8_t getOffsetZ(void);
...
// LATENT register
uint8_t getDoubleTapLatency(void);
void setDoubleTapLatency(uint8_t latency);

// WINDOW register
uint8_t getDoubleTapWindow(void);
...
// TAP_AXES register
int getTapAxisSuppress(void);
void setTapAxisSuppress(int enabled);
int getTapAxisXEnabled(void);
void setTapAxisXEnabled(int enabled);
int getTapAxisYEnabled(void);
void setTapAxisYEnabled(int enabled);
int getTapAxisZEnabled(void);
void setTapAxisZEnabled(int enabled);

// ACT_TAP_STATUS register
int getActivitySourceX(void);
int getActivitySourceY(void);
int getActivitySourceZ(void);
int getAsleep(void);
int getTapSourceX(void);
int getTapSourceY(void);
int getTapSourceZ(void);

// BW_RATE register
int getLowPowerEnabled(void);
void setLowPowerEnabled(int enabled);
uint8_t getRate(void);
void setRate(uint8_t rate);

// POWER_CTL register
int getLinkEnabled(void);
void setLinkEnabled(int enabled);
int getAutoSleepEnabled(void);
void setAutoSleepEnabled(int enabled);
int getMeasureEnabled(void);
void setMeasureEnabled(int enabled);
int getSleepEnabled(void);
void setSleepEnabled(int enabled);
uint8_t getWakeupFrequency(void);
void setWakeupFrequency(uint8_t frequency);

// INT_ENABLE register
int getIntDataReadyEnabled(void);
void setIntDataReadyEnabled(int enabled);
int getIntSingleTapEnabled(void);
void setIntSingleTapEnabled(int enabled);
int getIntDoubleTapEnabled(void);
void setIntDoubleTapEnabled(int enabled);
int getIntActivityEnabled(void);
void setIntActivityEnabled(int enabled);
int getIntInactivityEnabled(void);
void setIntInactivityEnabled(int enabled);
int getIntFreefallEnabled(void);
void setIntFreefallEnabled(int enabled);
int getIntWatermarkEnabled(void);
void setIntWatermarkEnabled(int enabled);
int getIntOverrunEnabled(void);
void setIntOverrunEnabled(int enabled);

// INT_MAP register
uint8_t getIntDataReadyPin(void);
void setIntDataReadyPin(uint8_t pin);
uint8_t getIntSingleTapPin(void);
void setIntSingleTapPin(uint8_t pin);
uint8_t getIntDoubleTapPin(void);
void setIntDoubleTapPin(uint8_t pin);
uint8_t getIntActivityPin(void);
void setIntActivityPin(uint8_t pin);
uint8_t getIntInactivityPin(void);
void setIntInactivityPin(uint8_t pin);
uint8_t getIntFreefallPin(void);
void setIntFreefallPin(uint8_t pin);
uint8_t getIntWatermarkPin(void);
void setIntWatermarkPin(uint8_t pin);
uint8_t getIntOverrunPin(void);
void setIntOverrunPin(uint8_t pin);

// INT_SOURCE register
uint8_t getIntDataReadySource(void);
uint8_t getIntSingleTapSource(void);
uint8_t getIntDoubleTapSource(void);
uint8_t getIntActivitySource(void);
uint8_t getIntInactivitySource(void);
uint8_t getIntFreefallSource(void);
uint8_t getIntWatermarkSource(void);
uint8_t getIntOverrunSource(void);

// DATA_FORMAT register
uint8_t getSelfTestEnabled(void);
void setSelfTestEnabled(uint8_t enabled);
uint8_t getSPIMode_ADXL345(void);
void setSPIMode_ADXL345(uint8_t mode);
uint8_t getInterruptMode(void);
void setInterruptMode(uint8_t mode);
uint8_t getFullResolution(void);
void setFullResolution(uint8_t resolution);
uint8_t getDataJustification(void);
...
// FIFO_CTL register
uint8_t getFIFOMode_ADXL345(void);
void setFIFOMode_ADXL345(uint8_t mode);
uint8_t getFIFOTriggerInterruptPin(void);
void setFIFOTriggerInterruptPin(uint8_t interrupt);
uint8_t getFIFOSamples(void);
void setFIFOSamples(uint8_t size);

// FIFO_STATUS register
int getFIFOTriggerOccurred(void);
uint8_t getFIFOLength(void);

// Configuration and driver functions 
int measure_ADXL345(float * ax,float * ay, float * az, uint8_t devAddr);
int configure_ADXL345(uint8_t devAddr);
#endif /* __adxl345_h */
