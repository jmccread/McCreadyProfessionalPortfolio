...
figure(98);
%filename = 'WorkspacesDemo2/WorkspacesDemo2_along_line_obstacle_forward_triangle.mat';% Works
%filename = 'WorkspacesDemo2/WorkspacesDemo2_along_line_complex_backward_triangles.mat'; % Works 
%filename = 'WorkspacesDemo2/WorkspacesDemo2_along_line_forward_triangle_facing_yellow.mat'; % Works, but is conservative
filename = 'WorkspacesDemo2/WorkspacesDemo2_along_line_complex_wall_2.mat'; % Works but is conservative
...
for m = 1:4
    ...
    imshow(C)
    tic
    %[lines, lineM, lineC, specular_mask, fore_mask] = getLine(C, 0, 0.6, 1);
    [right_dir(m), ~] = getTriangle(C, W, thresh_LD2, 1);
    toc
end 
right_dir
...
function [right_dir, long_line] = getTriangle(C, W, thresh_LD2, verbose)
